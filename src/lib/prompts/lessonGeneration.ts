...
function systemPrompt(input: GenerationInputs): string {
  ...
  return [
    ...
    "Wrong options must be real, plausible learner errors made of real words - never an invented form such as \"importanter\" - while still being unambiguously wrong.",
